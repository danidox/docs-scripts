...
To set up and test a sample app, follow the steps below. For details on how to configure the app, see [Configuring the CX Companion app](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/configuring-the-cx-companion-app).
...
5. Configure the folder for actions in the CX Companion app. For details, see [Configuring the CX Companion app](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/configuring-the-cx-companion-app) &gt; *Configure the folder for actions*.
