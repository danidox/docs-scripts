...
UiPath<sup>®</sup> Studio Web enables you to build and test cross-platform automations across online business apps and services.
...
* Take advantage of multiple automation templates to learn the basics of automation quickly.
...
For a complete list of supported services, see [Activities Overview](https://docs.uipath.com/overview/other/latest/overview/activities-overview#uipath-activity-packages).

If you want to see Studio Web in action with examples of automations you can create for various scenarios, check out the [Introducing Studio Web](https://www.youtube.com/watch?v=JFa3y0UbNfI&list=PLtZhfho3LWJZvzbeGkCDOTY6Z48sArEMJ) series of demos.

## Get started with Studio Web

To access Studio Web, go to [https://studio.uipath.com](https://studio.uipath.com/). If you don't have a UiPath account, sign up to [try UiPath for free](https://cloud.uipath.com/portal_/register?subscriptionPlan=trial), with options available for both commercial and non-commercial use.

If you are already logged in the UiPath cloud platform, you can access Studio Web from the left navigation menu in UiPath Automation Cloud.
  ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/398491)
...
:::important
Are you ready to create your first automation? [Go to the Templates page in Studio Web](https://studio.uipath.com/templates).
:::