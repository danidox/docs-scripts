...
1. From the ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/548970) **Project Explorer** panel on the left, access the agent **Definition**, **Evaluation sets**, and **Evaluators**.

Figure 1. The Agent inside a Solution
   ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/553787)
...
Figure 2. Configuring the model settings
   ![Configuring the model settings](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/587282)
...
Figure 3. Input arguments in the Data Manager panel
   ![Input arguments in the Data Manager panel](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/587286)
...
### Build an agent using Flow view (Preview)
   ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/608594)
...
6. Access additional options by selecting the ⋮ (More actions) menu on a tool node. The following actions are available:
   ...
   * **Disable** – Temporarily disables the selected tool node from agent execution. Disabled tools remain on the canvas but are skipped during runtime and debugging, allowing you to test or refine the agent’s behavior without permanently removing the tool.
   ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/608598)
7. Debug your agent.
