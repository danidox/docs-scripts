...
If you only want to display an image, it is recommended to use the [Image](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/image#image) control.
