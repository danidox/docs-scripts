...
:::tip
If you want to save time, use the [Upload email attachments from Gmail to Google Drive](https://cloud.uipath.com/portal_/cloudrpa?redirectPath=studio_/templates/472425f0-931e-4b2c-bf20-3ca263cbfb23) template to build this workflow.
:::
