...
When you publish a project to the personal workspace feed, a process and a trigger are automatically created in Orchestrator and the automation is added to the [Automations](https://docs.uipath.com/studio-web/automation-suite/latest/everyone-user-guide/managing-projects) page in Studio Web.
...
4. Click **Publish**.
   ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/398583)

To manage the versions of a published project, open the **Change history** panel from the ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/421615) icon on the upper-left side of the designer. The **Change history** panel lists project versions in chronological order starting from the current version (selected by default). Each entry in the panel contains:
