...
To rename an activity, click the name displayed in the activity title bar or select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Rename**.
...
To use this feature, click the name of an activity or a sequence in the title bar (or select **Actions** ![docs image](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Rename)**, and then select the **Summarize with Autopilot** button. Autopilot will then generate a unique name which describes what the activity or sequence does.

![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/398002)
...
To cut or copy an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Cut** or **Copy**.

To insert the activity you copied or cut in another location, do one of the following:

* On the activity after which you want to insert it, select **Actions** ![docs image](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Paste**.
...
To collapse / expand an activity, click anywhere in the empty space in the activity title bar, or select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Collapse** or **Expand**.
...
To add an annotation to an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Add annotation**, and then use the text box displayed under the title bar. After you add an annotation, you can edit it at any time. If you want to remove an annotation from an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Delete annotation**. Annotations are visible at the top of each activity. The annotation icon is displayed in the title bar of collapsed activities that contain an annotation.
...
To disable an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Disable**. When an activity is disabled, it is placed inside a disabled activity container. You can still configure it, but, unless you enable it again, the activity won't be executed when you run the project. To re-enable an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Enable** on the disabled activity container.
...
To extract an activity as a workflow, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) **Extract as Workflow**. In the **New Workflow** window, type in the name of the workflow, choose the location where to store it inside the project, and select **Create**. If the extracted workflow has the same name as an existing workflow, the extracted workflow keeps the name of the existing workflow followed by an incremental number.

## Removing an activity

To remove an activity, select it and press the **Delete** key, or select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Delete**.

## Accessing the documentation for an activity

To open the activity documentation on the UiPath<sup>®</sup> documentation portal, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Help** or press **F1** on your keyboard.
...
To add a breakpoint to an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Add breakpoint**.

When a breakpoint is set on an activity, the icon ![](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/StudioWeb/breakpoint.png) is displayed to the left of the activity's title bar.

To remove a breakpoint from an activity, select **Actions** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Remove breakpoint**.

## Identifying errors in an activity

If an activity has an incomplete or invalid configuration, the ![](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/2021.4_Studio/error_icon.png) icon is displayed on the right side of each property with errors, and the property name and outline are colored in red. An error icon is also displayed on the right side of the title bar of the activity and of all of its parent activities.
...
You can also see the errors or warnings in a project by accessing the **Issues Panel** from the ![](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/547990) icon on the upper-left side of the page. The number of identified issues is displayed next to the icon.
