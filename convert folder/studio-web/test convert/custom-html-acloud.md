...
The code from the panels is compiled into a project and rendered in Apps Studio for preview. To observe the functionality of the control, preview the app.
  ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/346261)
...
| AppsFile - value of a **File picker** control | JS File object ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/354030) |
