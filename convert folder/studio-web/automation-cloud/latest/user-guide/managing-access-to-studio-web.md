...
2. On the upper-right side of any Studio page, select the ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/503614) **Manage access** button.
   ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/623624)
