...
Open the **Change history** panel from the ![](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/421615) icon on the upper-left side of the designer to manage the versions of a published agentic process. The **Change history** panel lists project versions in chronological order starting from the current version (selected by default). Each entry in the panel contains:
...
After deployment, your process is listed in the **Processes** page. Selecting the process, then the **Edit** ![](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/542670) button opens the **Edit process** page, where you can update the process configuration, requirements, and additional settings.
...
When you publish a new version of an agentic process project, the **Updates are available** ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/542693) button appears under the **Version** column in the **Automations** &gt; **Processes** page. To upgrade your published project:

1. Select the **More actions** ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/542706) button on the right of the process.
