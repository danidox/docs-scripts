...
![Test input and output panels](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/582812)
4. Debug the workflow to execute the activity.
5. Check the **Output** panel to review the HTTP response.
   ![Debug panel with response](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/582820)