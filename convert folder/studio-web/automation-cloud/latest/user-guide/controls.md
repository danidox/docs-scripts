...
To configure the controls aesthetics, switch to the Style panel on the right-hand side. See [Layout and Styling](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/layout-and-styling) for more info.