...
![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/545312)
...
Selecting the **Automation details** ![](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/440701) icon takes you to the [Automation details](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/automation-details) page, where you can view details about your project runs, deployments, and connections.
...
* **Share** - Enables you to [share the project](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/sharing-and-collaborating-on-projects) with other users. The shared project is added to the list of projects for all the users you share it with, enabling you to collaborate on the project.
