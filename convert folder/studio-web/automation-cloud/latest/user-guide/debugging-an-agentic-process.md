...
* The **Action history** panel displays the comments logged from any manual interactions during execution.
  ![Debugging example](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/538492)
...
3. Select the ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/543250) breakpoint icon to add a breakpoint.
...
To remove a breakpoint, hover over the element that contains the breakpoint and select the ![](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/543236) remove breakpoint icon.
   ![Breakpoint](https://docs-dev.uipath.com/api/binary/studio-web/2/627891/538508)