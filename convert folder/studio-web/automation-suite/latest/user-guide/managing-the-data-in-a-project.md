...
To access the Data Manager for a project, select the ![docs image](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/StudioWeb/data-manager.png) icon on the left side of the Designer panel.
  ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/613671)
...
1. Open the Data Manager by selecting the ![docs image](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/StudioWeb/data-manager.png) **Open Data Manager** button on the left side of the Designer panel.
...
To view and manage entities added to your project, open the Data Manager by selecting the ![](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/StudioWeb/data-manager.png) **Open Data Manager** button on the left side of the Designer panel. The list of entities is displayed under the **Entities** sections.
...
1. In a project, click ![docs image](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/StudioWeb/data-manager.png) on the upper-right side of the page.
...
For each Integration Service connection, you can see the connection name, which activities use the connection, the activities and properties where user-specific data is used, and for some activities, you can click the icon next to each entry to scroll to the activity where the connection is used in the project. If a connection is invalid, the ![](https://documentationpicturerepo.blob.core.windows.net/screenshots/screenshots/2021.4_Studio/error_icon.png) icon is displayed next to the connection,

To more easily identify connections, you can add a few details that describe the role of each connection by selecting **See more** ![](https://documentationpicturerepo.blob.core.windows.net/migrated/More_VT.png) &gt; **Add purpose**.
