...
Use this control to compose rich text straight from the app in runtime.
  ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/94108)

:::note
If you select the **Read-only** box during runtime, the interface of the **Rich Text Editor** changes: the editing controls are hidden and you cannot add new text or edit the existing one. ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/92236)
:::
