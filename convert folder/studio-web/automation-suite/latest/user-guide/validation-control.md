...
The main workflow is as follows:
  ![docs image](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/591862)
...
4. Set the **Data Source** field of the **Validation Control** to the action input property ("cvd"). This sets AcctionProperties.cvd as the data source of your Validation Control.
   ![RPA workflow with document validation artifact](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/590166)
   ![RPA workflow with document validation artifact](https://docs-dev.uipath.com/api/binary/studio-web/2/627900/590178)
