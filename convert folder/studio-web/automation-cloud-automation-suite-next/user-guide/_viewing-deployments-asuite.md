...
To start a manual or scheduled automation, select the **Run** button on the right of the deployment. If an automation is triggered by an event, the icon ![](/images/studio-web/studio-web-image-event-trigger.png) is displayed and you can't manually start it.

Select the ![](/images/studio-web/studio-web-image-More_VT.png) **See more** menu on the right side of a deployment to view its details and configuration options in a new, resizable window on the right of the page:
...
* Connections and activity properties with user-level settings which you can configure in order to run the automation with your data. For example, in an automation that involves items from SharePoint lists and Outlook emails, you can select your SharePoint and Outlook connections, and which SharePoint list to use.
  ...
  ![docs image](/images/studio-web/studio-web-docs-image-366595.webp)
...
* Description
* Apps used. For automations triggered by an event, the icon ![docs image](/images/studio-web/studio-web-image-event-trigger.png) is displayed next to the app containing the event that triggers the automation.
...
* Trigger type (manual, time, or event)
  ...
  ![docs image](/images/studio-web/studio-web-docs-image-366591.webp)

Additional options are available in the ![docs image](/images/studio-web/studio-web-image-More_VT.png) **See more** menu;

* **Show job history** - Opens the [Jobs](https://docs.uipath.com/studio-web/automation-suite/latest/everyone-user-guide/viewing-jobs) page for this particular version of the automation.
...
To see the full list of deployments, select the **detailed view** button next to the **Deployments** section title.
  ...
  ![docs image](/images/studio-web/studio-web-docs-image-440843.webp)