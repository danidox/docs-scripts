...
1. Do one of the following:
   * From the **Automations** page, select **See more** ![docs image](/images/studio-web/studio-web-image-More_VT.png) &gt; **Share** on the right side of a project.
...
In the list of projects, the icon ![](/images/studio-web/studio-web-image-shared-automation.png) is displayed next to the owner for projects that are shared. If you are the owner of a project, the owner appears as *me*. If a project is owned by someone else and shared with you, the user is displayed as the owner for that project.
