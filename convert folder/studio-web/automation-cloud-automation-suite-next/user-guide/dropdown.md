...
* **Disabled** - If true, disables the control at runtime.
  :::note
  You can use [arrays to populate the options](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/use-arrays-to-populate-dropdown-controls) of a **Dropdown** control.
  :::
