...
To use this feature, click the name of an activity or a sequence in the title bar (or select **Actions** ![docs image](/images/studio-web/studio-web-image-More_VT.png) &gt; **Rename)**, and then select the **Summarize with Autopilot** button. Autopilot will then generate a unique name which describes what the activity or sequence does.

![docs image](/images/studio-web/studio-web-docs-image-398002.webp)
