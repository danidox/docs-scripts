...
To use a variable in an activity, select **See more** ![docs image](/images/studio-web/studio-web-docs-image-see-more.png) &gt; **Use Variable** next to an input field or click a field labeled *Click to use a variable*. You can also add variables inside other editors and builders like the text builder and the rich text composer. The variable selection window displays all the variables and arguments in the project.
...
For example, when you build an automation that is triggered by an [Email received](https://docs.uipath.com/activities/other/latest/user-guide/google-workspace-trigger-new-email-received) event in Gmail, the output of the trigger activity (the retrieved email) is automatically saved as a variable which stores the retrieved email as well as all of the individual properties of the email, such as the sender, subject, body, attachments, etc.
  ...
  ![docs image](/images/studio-web/studio-web-docs-image-359861.webp)
...
If you add a [Forward Email](https://docs.uipath.com/activities/other/latest/user-guide/google-workspace-email-forward-email-connections) activity to automatically forward the retrieved email, you select the **Email** variable to indicate the email to forward.
  ...
  ![docs image](/images/studio-web/studio-web-docs-image-359866.webp)
