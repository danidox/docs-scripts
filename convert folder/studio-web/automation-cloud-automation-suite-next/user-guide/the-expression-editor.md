...
The Expression editor allows you to use VB operators and functions, while respecting a predefined syntax. You can identify the properties that can be configured using VB expressions by the "tune" icon ![](/images/studio-web/studio-web-image-280277.webp).
