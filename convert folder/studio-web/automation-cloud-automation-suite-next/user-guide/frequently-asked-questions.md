...
Studio Web was designed to be easy to use. The built-in templates help you get acquainted with Studio Web and start automating right away. You can learn more by taking the Studio Web course available in the [UiPath<sup>®</sup> Academy](https://academy.uipath.com/courses/introduction-to-uipath-studio-web).
...
Studio Web provides a range of benefits that streamline onboarding and simplify automation building:
...
There are many activity packages available in Studio Web, with more to be added in the future. For a list of packages, see [Activities reference](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/activities-reference). The activities that are available in Studio Web are also available in Studio.
...
You can currently use Studio Web to create:

* [RPA workflow projects](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/rap-workflow-projects) with sequences and with multiple workflows.
* [App projects](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/app-projects).
* [Agentic process projects](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/agentic-processes).
* [Agents](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/agents).
* [Solutions](https://docs.uipath.com/studio-web/automation-cloud/latest/everyone-user-guide/solutions).
