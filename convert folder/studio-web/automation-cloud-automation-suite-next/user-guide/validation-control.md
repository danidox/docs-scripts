...
The main workflow is as follows:
  ...
  ![docs image](/images/studio-web/studio-web-docs-image-591862.webp)
...
4. Set the **Data Source** field of the **Validation Control** to the action input property ("cvd"). This sets AcctionProperties.cvd as the data source of your Validation Control.
   ...
   ![RPA workflow with document validation artifact](/images/studio-web/studio-web-rpa-workflow-with-document-validation-artifact-590166.webp)

   ![RPA workflow with document validation artifact](/images/studio-web/studio-web-rpa-workflow-with-document-validation-artifact-590178.webp)
