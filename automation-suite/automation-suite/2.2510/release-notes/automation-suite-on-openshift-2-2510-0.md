...
title: "2.2510.0"
visible: true
slug: "automation-suite-on-openshift-2-2510-0"
---
...
We are excited to announce that Test Cloud is now available on-premises through the OpenShift deployment. This release brings the full Test Cloud experience to self-managed environments, allowing you to design, execute, and manage automated tests securely and at scale within your organization’s infrastructure.
...
The documentation for Test Cloud on-premises, delivered through OpenShift deployment is available in the following installation, admin, user, and API guides:

* [OpenShift installation guide](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/automation-suite-overview)
...
We are happy to announce the addition of Integration Service, Studio Web, Solutions, and Autopilot for Everyone to our Automation Suite product portfolio. This expansion aligns with our aim to maintain parity with the functionalities offered via Automation Cloud.

If you plan to enable these new products, make sure to check out the [cross-product dependencies](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/automation-suite-products) and that you meet all the [prerequisites](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/prerequisites-at-a-glance).

All the details about the installation and configuration of these newly onboarded products are available in the [Automation Suite on OpenShift Installation Guide](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/preparing-the-installation). For details on how make the most out of the functionality of these products, refer to the individual product guides:
...
* [Studio Web for Automation Suite User Guide](https://docs.uipath.com/studio-web/automation-suite/2.2510/user-guide/overview)
...
1. [Configure Istio for multiple installations in a single cluster](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/installing-and-configuring-the-service-mesh#step-3%3A-configuring-istio-for-multiple-installations-in-a-single-cluster)
2. [Grant installation permissions](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/granting-installation-permissions)
3. [Configure ArgoCD for multiple installations in a single cluster](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/installing-and-configuring-the-gitops-tool#configuring-argocd-for-multiple-installations-in-a-single-cluster)
4. [Deploy Redis through OperatorHub](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/deploying-redis-through-operatorhub)
5. [Install multiple Automation Suite instances on a single cluster](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/configuring-inputjson#installing-multiple-automation-suite-instances-on-a-single-cluster)
...
For details, see [Disaster Recovery – Active/Passive](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/disaster-recovery) and [Quick links](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/quick-links).
...
For configuration details, refer to the [Networking](https://docs.uipath.com/automation-suite/automation-suite/2.25100/installation-guide-openshift/networking) section.
...
You can also bring your own external secrets operator. For details, refer to [Installing the External Secrets Operator](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/installing-the-external-secrets-operator).
...
For details, refer to [Credentials secretstore configuration](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/configuring-inputjson#credentials-secretstore-configuration).
...
For details, refer to [Configuring input.json](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/configuring-inputjson).
...
For details, refer to the [Migration and upgrade](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/migrating-standalone-products-to-automation-suite) section.
...
For details, refer to [Security and compliance](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/security-and-compliance).
...
We fixed the issue in [Automation Suite 2.2510.1](https://docs.uipath.com/automation-suite/automation-suite/2.2510/release-notes/automation-suite-on-openshift-2-2510-1#bug-fixes).
