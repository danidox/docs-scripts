...
title: "2.2510.1"
visible: true
slug: "automation-suite-on-openshift-2-2510-1"
---
...
For details, refer to [Generating the support bundle](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/running-the-support-bundle-tool).

## Support for OpenShift Service Mesh 3.0

Automation Suite now supports OpenShift Service Mesh (OSSM) 3.0.

For installation instructions, refer to [Installing and configuring the service mesh](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/installing-and-configuring-the-service-mesh).

For the compatibility matrix between OpenShift Service Mesh versions and Automation Suite on OpenShift versions, refer to the [OpenShift third-party component compatibility matrix](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-openshift/compatibility-matrix#openshift-third-party-component-compatibility).
...
* This release includes the fixes delivered in [Automation Suite 2.2510.0+patch1](https://docs.uipath.com/automation-suite/automation-suite/2.2510/release-notes/automation-suite-on-openshift-2-2510-0-patch-1#225100%2Bpatch1).
