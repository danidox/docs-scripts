...
5. Go to the ArgoCD panel, in the Document Understanding section and check if the Extended Languages OCR is displayed.
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/486954)
