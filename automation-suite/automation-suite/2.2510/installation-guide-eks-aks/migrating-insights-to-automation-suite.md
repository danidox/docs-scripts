...
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/157632)
2. Create a backup.
   ```
...
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/158136)
3. Exit the SSH.
   ```
   exit
   ```
...
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/158309)
...
1. Download the `kubeconfig` file. The following screenshot shows an [Azure deployment template for Automation Suite](https://docs.uipath.com/automation-suite/docs/azure-deployment-architecture).
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/161388)
2. Open an SSH client and run the following command to get the Insights Looker pod name
   ...
   ```
3. The Insights Looker pod is now listed (e.g., `insights-insightslooker-c987df55c-gngqd`).![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/158839)
...
Open `sf_db_backup/looker.log` and search for `host_url` to find the string that starts with `https://`.
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/159588)

Search for `INSERT INTO "CREDENTIALS_EMAIL" VALUES(1,1,'admin@uipath.com'` in `sf_db_backup/looker.log`.
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/157461)
