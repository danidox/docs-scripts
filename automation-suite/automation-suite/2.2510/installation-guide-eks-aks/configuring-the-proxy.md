...
To create a connection to Integration Service connectors and allow data traffic from your cluster to connector domains, you must configure an allowlist for connector domains. Refer to [Configuring an allowlist for connector domains](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-eks-aks/configure-urls-allowlist) for the full list of URLs.