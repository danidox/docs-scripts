...
**Online deployment**
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/621054)

**Offline deployment**
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/330697)
...
**Online deployment**
  ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/621059)

**Offline deployment**
  ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/596477/621063)
...
<table cellpadding="4" cellspacing="0" class="table css-13i9z9m esqyda30" summary="">
 ...
 <tbody>
  <tr>
   <td headers="d54902e172">
    <p>
     <strong>
      Multi-node
     </strong>
     &mdash; production, HA-enabled
    </p>
   </td>
   <td headers="d54902e175">
    <p>
     Supported for production use.
    </p>
    <p>
     You can choose between two varieties of multi-node mode:
    </p>
    <ul>
     <li>
      <p>
      ...
      <p>
       By default, the infrastructure and shared components are set to HA mode, while all services are set to non-HA (horizontal
                                       pod autoscaling is enabled with a minimum of one replica). You can set specific services to HA. You also have the option of
                                       performing additional configuration post-deployment to have full HA capabilities.
      </p>
     </li>
     <li>
      <p>
      ...
      <p>
       Fully enabled HA, with either in-cluster high availability or external high availability.
      </p>
     </li>
    </ul>
   </td>
...
Lite mode installations offer a simple, resource-light setup process, including all features except high availability. Lite mode ensures flexible infrastructure management by allowing you to enable high availability for select services during or after installation as needed.
:::important
...
Multi-node installations are supported for production deployments, providing increased scalability, enhanced reliability, and efficient resource management.
