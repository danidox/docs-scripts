...
<table cellpadding="4" cellspacing="0" class="table css-13i9z9m esqyda30" summary="">
 ...
 <tbody>
  <tr>
   <td headers="d41025e437">
    Cleanup XML
   </td>
   <td colspan="2" headers="d41025e441 d41025e444">
    <p>
     They both use the logic described in the
     <strong>
      <a href="https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-eks-aks/cleaning-up-the-orchestrator-database#scheduling-the-cleanup">
       Scheduling the cleanup
      </a>
     </strong>
     section.
...
The
  ...
  <tr>
   ...
   <td headers="d41025e441">
    <p>
     Stored in a temporary table.
    </p>
   </td>
   <td headers="d41025e444">
    Stored in the
    <code>
     dbo.__CleanupIds
    </code>
