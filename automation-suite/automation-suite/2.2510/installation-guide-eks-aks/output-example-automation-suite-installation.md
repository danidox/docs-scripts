...
The following example shows the output you may get after installing Automation Suite. For details, see [Installing Automation Suite](https://docs.uipath.com/automation-suite/automation-suite/2.2510/installation-guide-eks-aks/installing-automation-suite#installing-automation-suite).
