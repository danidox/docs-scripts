...
4. Configure conditions based on the log level or other events (see [Log rules example](https://docs.uipath.com/automation-suite/automation-suite/2023.10/installation-guide-eks-aks/configuring-log-rules#log-rules-examples)).
