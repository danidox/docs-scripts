...
:::tip
Check the list of databases and their default names in [SQL database](https://docs.uipath.com/automation-suite/automation-suite/2023.10/installation-guide-eks-aks/sql-database#sql-database).
:::
...
**postgresql_connection_string_template_sqlalchemy_pyodbc example (Process Mining 2023.10.9 or higher)**
```
