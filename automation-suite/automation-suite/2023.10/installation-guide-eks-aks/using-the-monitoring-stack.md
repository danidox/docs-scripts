...
To access the monitoring tools for the first time, follow the instructions in [Accessing Automation Suite](https://docs.uipath.com/automation-suite/automation-suite/2023.10/installation-guide-eks-aks/accessing-automation-suite#accessing-monitoring).
...
* Check **Show annotations** to display messages corresponding to alerts.
  ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/314970)

## Silencing alerts

If alerts are too noisy, you can silence them. To do that, take the following steps:

1. Select the **Alertmanager** tile in the upper left corner of the **Monitoring** dashboard. The following screen is displayed.
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/206375)
2. Find the alert in question, and select **Silence**.
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/207919)
...
:::note
Before starting configuring the alerts, make sure to [enable kubectl](https://docs.uipath.com/automation-suite/automation-suite/2023.10/installation-guide-eks-aks/accessing-automation-suite#enabling-kubectl).
:::
...
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/206631)
...
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/206735)
...
![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/206351)

## Creating shareable visual snapshot of a Grafana chart

1. Select the downwards pointing arrow next to the chart title, and then select **Share**.
2. Select the **Snapshot** tab, and set the **Snapshot name**,**Expire**, and **Timeout**.
...
On the **Monitoring Dashboard**, select **Prometheus Graph**. A new window is displayed.
   ![docs image](https://docs.uipath.com/api/binary/automation-suite/2/309203/209652)
