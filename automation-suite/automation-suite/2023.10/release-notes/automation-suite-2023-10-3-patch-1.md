---
title: "2023.10.3+patch1"
visible: true
slug: "automation-suite-2023-10-3-patch-1"
---
...
**Erratum - added August 8, 2024**: The bug fix related to document validation tasks in Action Center was not included in the Automation Suite 2023.10.4 release. We recommend that you wait for Automation Suite 2023.10.5 to get this fix.

This release applies a patch to Automation Suite 2023.10.3. The patch addresses an issue preventing some document validation tasks from being displayed accurately in Action Center. For more details, see the individual product release notes referenced in the [Product versions](https://docs.uipath.com/automation-suite/automation-suite/2023.10/release-notes/automation-suite-2023-10-3-patch-1#product-versions) section.
...
| --- | --- | --- | --- |
| Automation Hub 2023.10.3 | Automation Ops 2023.10.3 | AI Center 2023.10.3 | [Action Center 2023.10.3-patch1](https://docs.uipath.com/action-center/automation-suite/2023.10/user-guide/release-notes-2023-10-3-patch1) |
| Task Mining 2023.10.3 | AI Computer Vision 2023.10.2 | Insights 2023.10.3 | Apps 2023.10.3 |
| Process Mining 2023.10.3 | [Document Understanding 2023.10.3](https://docs.uipath.com/document-understanding/automation-suite/2023.10/release-notes/release-notes-document-manager-automation-suite-2023-10-3-patch1) | [Orchestrator 2023.10.4-patch1](https://docs.uipath.com/orchestrator/automation-suite/2023.10/release-notes/2023-10-4-patch-1) |  |
