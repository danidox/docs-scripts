...
This section provides key considerations and high-level steps for migrating from Test Suite under the Flex pricing plan to Test Cloud under the Unified Pricing plan. Consider taking these steps before performing the actual [license migration steps from Flex licensing to Unified Pricing licensing](https://docs.uipath.com/test-cloud/automation-cloud/latest/workspace/license-migration).
...
* Test Cloud is a dedicated cloud service focused on application testing. Test Cloud extends the testing capabilities previously available in UiPath® Test Suite. Unlike UiPath Test Suite, which was part of broader automation offerings, Test Cloud is a cloud offering similar to Automation Cloud, but designed specifically for application testing. Historically, UiPath Test Suite capabilities were delivered as part of Automation Cloud. These capabilities covered both RPA testing and application testing.
...
* **Where are these activities performed?**: Let us know whether application testing and RPA/automation testing are managed within the same organization, or in separate organizations.
* **What activities are you planning to migrate?**: Indicate whether it is just application testing to Test Cloud or you also want to upgrade RPA/automation testing capabilities to the .

## Planning and assessment

During this phase, your goal is to understand the current setup and plan the scope of migration. TOPLEVELNOTEMARKER
  :::tip
