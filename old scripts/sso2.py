...
def transform_admonitions(container: BeautifulSoup) -> None:
    ...
    for div in container.find_all("div", class_=True):
        ...
        inner_md = md.markdownify(str(inner_soup), heading_style="ATX", autolinks=False).strip()
        ...
        while queue:
            ...
            try:
                ...
                if doc_container:
                    ...
                    markdown_content = md.markdownify(str(doc_container), heading_style="ATX", strip=["br"], autolinks=False)  # ignore any surviving <br>
