...
:::note
The DataSource property is migrated as blank for several controls, such as Table, Dropdown, or List. Use the [Query Builder](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/the-query-builder#the-query-builder "Gets the number of records for an entity, for example SystemUsers.For example, for the Edit Grid control:") to rebuild the expression.
:::
...
Errors might occur if an integration name does not respect [the naming convention](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/best-practices-#naming-conventions) for VB elements. The migration algorithm renames the element on your behalf.
...
Make sure the variable names respect [the naming convention](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/best-practices-#naming-conventions) for VB elements.
