...
To try the **Dropdown** yourself, use the demo app.

|  |
| --- |
| [Download demo app from GitHub](https://github.com/UiPath/AppsClientSample/blob/master/demo-apps/controls/dropdown/DistinctValues.uiapp) |

### Demo app - instructions to use

1. In UiPath Apps, create a new app and import the downloaded demo app.
2. To interact with the Dropdown control, preview your app.

## General

* **List Source** - The source for the items to be displayed in the dropdown. Valid data types include arrays of String, Integer, or DateTime, DataTable, or arrays of an Object.
...
* **Disabled** - If true, disables the control at runtime.
  :::note
  You can use [arrays to populate the options](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/use-arrays-to-populate-dropdown-controls) of a **Dropdown** control.
  :::
