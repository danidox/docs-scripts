...
You can manage your notifications using the **My Notification** view from the **Notifications** settings page. For details, refer to [Notifications settings](https://docs.uipath.com/automation-cloud/automation-cloud/latest/admin-guide/exploring-the-user-interface#notifications-settings-page).
