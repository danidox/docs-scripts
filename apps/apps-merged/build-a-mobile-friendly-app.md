...
To demonstrate this, follow the steps from the [Tutorial](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/build-a-mobile-friendly-app#tutorial) section.
