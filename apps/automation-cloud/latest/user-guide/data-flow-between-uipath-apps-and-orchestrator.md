...
The sections below describes the **UiPath Apps** data flow when using cloud apps with an [on-prem](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/onprem#connecting-apps-to-an-on-premises-orchestrator-instance) (or self hosted) **Orchestrator**.
