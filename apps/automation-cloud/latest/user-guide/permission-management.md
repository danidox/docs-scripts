...
The availability of custom roles depends on your cloud offering. For details, refer to [Apps feature availability](https://docs.uipath.com/apps/automation-cloud/latest/workspace-user-guide/apps-feature-availability).
