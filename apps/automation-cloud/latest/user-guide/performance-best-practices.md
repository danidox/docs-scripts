...
[Page Container](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/tabs#tabs) controls allow you to reuse a page within another page. Continuously switching pages in a Page Container can cause high memory usage in the browser. The upper limit of page switch events which cause this high memory usage depends on the volume of RAM in your system.

[Tab](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/tabs#tabs) controls allow you to reuse a page in multiple tabs. Using the Tab control is more efficient in terms of memory usage than replicating tabs using Page Container controls.
