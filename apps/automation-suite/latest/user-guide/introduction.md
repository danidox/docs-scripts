...
* **Unattended:** (one or more of the following)
  ...
  + Hybrid w/ On-Prem – for details, refer to[Connect your on-premise orchestrator to UiPath Apps Service](https://docs.uipath.com/apps/automation-suite/latest/user-guide/onprem#connecting-apps-to-an-on-premises-orchestrator-instance).
