...
To configure the controls aesthetics, switch to the Style panel on the right-hand side. See [Layout and Styling](https://docs.uipath.com/apps/automation-suite/latest/user-guide/layout-and-styling#layout-and-styling) for more info.