...
To try setting the external content yourself, use the demo app or follow the [procedure](https://docs.uipath.com/apps/automation-suite/latest/user-guide/set-external-context#procedure).
...
1. Run the [demo app](https://docs.uipath.com/apps/automation-suite/latest/user-guide/set-external-context#introduction). All the expressions using the `App.QueryParam` function should display their default values.
