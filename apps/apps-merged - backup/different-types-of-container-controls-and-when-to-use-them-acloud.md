...
<table cellpadding="4" cellspacing="0">
 ...
 <thead>
  <tr>
   <th> <p><a href="https://docs.uipath.com/apps/automation-cloud/latest/user-guide/container#container"> Container </a></p> </th>
   <th> <p><a href="https://docs.uipath.com/apps/automation-cloud/latest/user-guide/container-layout#container-layout"> Container Layout </a></p> </th>
   <th> <p><a href="https://docs.uipath.com/apps/automation-cloud/latest/user-guide/page-container#page-container"> Page Container </a></p> </th>
  </tr>
 </thead>
 <tbody>
  <tr>
...
3. Add the two **Textboxes** within the container.
   ...
   ![docs image](/images/apps/apps-docs-image-93153-6af0c97f.gif)