...
You can use [arrays to populate the options](https://docs.uipath.com/apps/automation-cloud/latest/user-guide/use-arrays-to-populate-dropdown-controls) of a **Multiselect Dropdown** control.
