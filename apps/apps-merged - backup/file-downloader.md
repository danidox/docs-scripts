...
* **Source** - The source of the document users can download. Only URLs and variables of type `IResource` are accepted, configured as follows:
  ```
  New IResource("https://imageURL.com")
  ```
