...
* **List Source** - The source for the items to be displayed in the list. Valid data types include arrays of String, Integer, or DateTime, DataTable, or arrays of an Object.
