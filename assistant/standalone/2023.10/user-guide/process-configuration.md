...
Besides arguments, you can also configure an automation to always start in a [PiP Session](https://docs.uipath.com/assistant/standalone/2023.10/user-guide/picture-in-picture) from the same menu.
