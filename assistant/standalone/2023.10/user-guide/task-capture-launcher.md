...
After the application is [installed](https://docs.uipath.com/task-capture/standalone/2023.10/user-guide/installing-task-capture), the user must acquire a license by following the steps from [this document](https://docs.uipath.com/task-capture/standalone/2023.10/user-guide/activation).
:::note
