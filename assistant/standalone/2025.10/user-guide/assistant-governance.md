...
* **Enable Task Capture** - Select **Yes** to show the [Task Capture Launcher](https://docs.uipath.com/robot/standalone/2025.10/user-guide/task-capture-launcher).
