...
* **Keyboard Shortcuts**—Configure [keyboard shorcuts](https://docs.uipath.com/assistant/standalone/2025.10/user-guide/field-descriptions#keyboard-shortcuts-in-assistant) for diverse automation-related commands, such as:
