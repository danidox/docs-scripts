...
* [Child Session](https://docs.uipath.com/assistant/standalone/2025.10/user-guide/pip-child-session#pip---child-session) - Processes run in a separate Windows session on the machine.
* [Virtual Desktop](https://docs.uipath.com/assistant/standalone/2025.10/user-guide/pip-virtual-desktop) - Processes run in the same Windows session, but on a virtual desktop.
