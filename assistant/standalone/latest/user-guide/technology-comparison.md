...
`2` More information on how PiP - Child Session works with VPN can be found [here](https://docs.uipath.com/assistant/standalone/latest/user-guide/pip-child-session#known-issues-and-limitations).
...
`2` These input methods may not work on all applications. Check the [Input methods](https://docs.uipath.com/studio/standalone/latest/user-guide/input-methods) table for the overall compatibility with applications.
