...
* Use an **Invoke Isolated Workflow** activity to invoke the part of the automation using Microsoft Office and set its [Target Session](https://docs.uipath.com/assistant/standalone/2024.10/user-guide/picture-in-picture) to **Picture in Picture** from Studio.
