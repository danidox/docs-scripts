...
Widgets built by UiPath are distributed via the Official Feed. Based on the governance policies, widgets are downloaded and installed in the UiPath Assistant.
...
4. Widget is downloaded and added to the UiPath Assistant.
   ...
   ![docs image](/images/assistant/automation-cloud-docs-image-102799-ea90042b.webp)
